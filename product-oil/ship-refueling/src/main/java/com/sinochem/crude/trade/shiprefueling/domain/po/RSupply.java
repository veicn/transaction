...
public class RSupply implements Serializable {
	...
	/**加油日期*/
	private java.util.Date fuelChargingTime;  
	
	/**供油单号*/
	private String fuelChargingCode;  
	...
	/**加油日期*/
	public void setFuelChargingTime(java.util.Date fuelChargingTime){
		this.fuelChargingTime=fuelChargingTime;
	}
	/**加油日期*/
	public java.util.Date getFuelChargingTime(){
		return this.fuelChargingTime;
	}
	
	/**供油单号*/
	public void setFuelChargingCode(String fuelChargingCode){
		this.fuelChargingCode=fuelChargingCode;
	}
	/**供油单号*/
	public String getFuelChargingCode(){
		return this.fuelChargingCode;
	}
	...
	map.put("fuelChargingTime",this.fuelChargingTime);
	map.put("fuelChargingCode",this.fuelChargingCode);
