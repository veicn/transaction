<template>
  <div class="Interface-cont2">
        ...
        <div class="box-c2">
          <div class="bgcf">
            <div class="cont2-bd" @click="openPicker(4)">
              ...
              <span class="s-input"> {{datas.norTendered}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <div class="cont2-bd" @click="openPicker(5)">
              <span>Anchor Aweigh</span>
              <span class="s-input"> {{datas.anchorAweigh}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
          </div>
          ...
          <div class="bgcf">
            <div class="cont2-bd" @click="openPicker(6)">
              <span>Date&Time</span>
              <span class="s-input"> {{datas.pobDatetimeOne}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <div class="cont2-bd">
          ...
          <div class="bgcf">
            <div class="cont2-bd" @click="openPicker(7)">
              <span>Date&Time</span>
              <span class="s-input"> {{datas.firstLineDatetime}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <div class="cont2-bd" @click="openPicker(19)">
              <span>ETB</span>
              <span class="s-input"> {{datas.firstLineEtb}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <div class="cont2-bd">
             ...
             <div class="cont2-bd" @click="openPicker(16)">
              <span> All Fast</span>
              <span class="s-input"> {{datas.allFast}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
          </div>
        ...
        <div class="box-c3">
          ...
          <div class="bgcf">
            <div class="cont2-bd" @click="openPicker(8)">
              <span>Date&Time</span>
              <span class="s-input"> {{datas.tanksInspectionDatetime}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <div class="cont2-bd">
          ...
          <div class="bgcf">
            ...
            <div class="cont2-bd" @click="show=!show">
              <span>Independent Inspection</span>
              <input disabled type="text" placeholder="Please Select" :value="newDatas">
            </div>
            ...
            <div class="cont2-bd" @click="openPicker(9)">
              <span>Date&Time</span>
              <span class="s-input"> {{datas.independentInspectionDatetime}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <!-- <div class="cont2-bd">
            ...
            <div class="cont2-bd" @click="openPicker(10)">
              ...
              <span class="s-input"> {{datas.shoreArmsConnecting}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
          ...
          <div class="bgcf">
            <div class="cont2-bd" @click="openPicker(11)">
              <span>Date&Time</span>
              <span class="s-input"> {{datas.commencedLoadingDatetime}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <div class="cont2-bd" @click="openPicker(12)">
              <span>ETC</span>
              <span class="s-input"> {{datas.etc}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <div class="cont2-bd" @click="openSidebar">
              <span>Loading Progress</span>
              <i class="c2-time">&gt;</i>
            </div>
            <div class="cont2-bd" @click="openPicker(13)">
              <span>Completed Loading</span>
              <span class="s-input"> {{datas.completedLoadingDatetime}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
        ...
        <div class="box-c4">
          <div class="bgcf mart20">
            <div class="cont2-bd" @click="openPicker(14)">
              ...
              <span class="s-input"> {{datas.shoreArmDisconnecting}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
          ...
          <div class="bgcf">
            <div class="cont2-bd" @click="openPicker(15)">
              <span>Date&Time</span>
              <span class="s-input"> {{datas.leaveDatetime}}<img src="../../../../../assets/img/Page 1@2x.png" alt=""></span>
            </div>
            <!-- <div class="cont2-bd">
              <span>Next Port</span>
    ...
    <div class="buzou">
      ...
      <mt-button class="c2-save" @click="baocun9(selected*1)">{{!isPosting?'Save':'Saving...'}}</mt-button>
      <span v-if="selected!='4'" @click="next1(selected)" class="fr"> Next step＞</span>
    </div>

    <div class="sidebar">
      <transition name="fade" @touchmove.prevent>
        <div class="menu-mask" v-show="sidebarOp" @click="closeSidebar"></div>
      </transition>
      <transition name="side">
        <div v-show="sidebarOp" class="menu-content">
...
export default {
  ...
  props:['message'],
  components: {'myProgress': progress},
  watch: {},
  created() {
...
.menu-mask.fade-enter-to,.menu-mask.fade-leave-to {
  transition:opacity .3s
}
.menu-mask.fade-enter,.menu-mask.fade-leave-to {
 opacity:0
}
