...
import com.sinochem.crude.trade.common.utils.Digest;
...
public class SystemNotificationHelper {
    ...
    public String sendMessage(String url, List<NameValuePair> params) throws BizException {
        String result = "200";
        try {
            //POST的URL
     ...
     * @return
     */
    public List<NameValuePair> generateTplMailParams(String tplName, String subject, String receiver, Map<String, Object> model) {
     ...
     * @return
     */
    public List<NameValuePair> generateSmsParams(String tplName,String mobileNo, Map<String, Object> model) {
        List<NameValuePair> param = new ArrayList<NameValuePair>();
        param.add(new BasicNameValuePair("memberId", CommonUtils.PLANTFORM_MEMBER_ID + ""));
     ...
     * @return
     */
    public List<NameValuePair> generateMessageParams( String tplName, String toId, String level,String title,Map<String, Object> model) {
        List<NameValuePair> param = new ArrayList<NameValuePair>();
     ...
     * @return
     */
    public List<NameValuePair> generateAPPParams( String tplName, String toId,Map<String, Object> model) {
        List<NameValuePair> param = new ArrayList<NameValuePair>();
