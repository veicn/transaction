 ...
 function Echo(){
	 ...
	 layui.use('laydate', function () {
         ...
         $('.voyage-table>tbody').append(`
			 ...
			 <input name="date" id="${id}" value="${date.date}" title="${date.date}" class="DeadlineMonth DeadlineMonth2 datetime" type="text" style="width: 127px;">
			 ...
			 <td class="pd0">
			 <div class="datetime-wrap">
			 <input name="etb" id="${id+'b'}" value="${date.etb}" title="${date.etb}" class="DeadlineMonth  DeadlineMonth2 datetime" type="text" style="width: 127px;">
			 ...
			 <div class="select-show-text"  >${selvalue}</div>
			 <input type="text" name="sea"  readonly="readonly" title="${selvalue}" value="${date.sea}">
			 </div>
			 </div>
			 ...
			 <td class="loadingPort pd0"><input type="text" name="aveSpd24h" maxlength="6"  title="${date.aveSpd24h}"  value="${date.aveSpd24h}" ></td>
