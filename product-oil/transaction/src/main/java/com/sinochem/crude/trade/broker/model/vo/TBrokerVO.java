...
public class TBrokerVO extends TBrokerDeclaration {
    ...
    public List<TCommonAttachments> gettBrokerBillsFile() {
        return tBrokerBillsFile;
    }

    public void settBrokerBillsFile(List<TCommonAttachments> tBrokerBillsFile) {
        this.tBrokerBillsFile = tBrokerBillsFile;
    }

    private List<TCommonAttachments> tBrokerBillsFile;
