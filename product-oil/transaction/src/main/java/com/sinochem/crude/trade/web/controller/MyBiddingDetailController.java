 ...
 */
@Controller
@RequestMapping(UrlMapping.MY_BIDDING_DETAIL)
public class MyBiddingDetailController {
    ...
    public ModelAndView index(CurrentUser currentUser, String uuid, ModelMap model) {
        ...
        try {
            ...
            List<BiddingSheet> biddingSheets = biddingSheetService.selectHistoryBySaleSheetId(currentUser,biddingSheetQuery);
