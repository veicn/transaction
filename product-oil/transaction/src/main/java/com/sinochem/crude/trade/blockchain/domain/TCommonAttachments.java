...
public class TCommonAttachments {
    ...
    //channel
    public static final String CHANNEL_SHIPAGENT = "SHIPAGENT";
    public static final String CHANNEL_BROKER = "BROKER";
    public static final String CHANNEL_INSPECTOR = "INSPECTOR";
    public static final String CHANNEL_TRANS = "TRANS";

    //fileType
    public static final String FILETYPE_SOF = "1";
    public static final String FILETYPE_BL = "2";
    public static final String FILETYPE_INSPECTOR = "3";
