 ...
 * date: 20180307
 */
public enum DemandSheetQueryOrderEnum {

    POSTING_DATE("1", "发布时间", "Posting Date", "demandSheet.released_date"),
    ...
    DemandSheetQueryOrderEnum(String code, String zhName, String enName, String column) {
        this.code = code;
        this.zhName = zhName;
        this.enName = enName;
        this.column = column;
