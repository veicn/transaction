...
public interface TransportInfoMapper {
     ...
     * 根据主键修改对象
     */
    int updateByPrimaryKey(TransportInfo transportInfo);

    /**
     * 根据主键修改对象，更新有值的字段
     */
    int updateByPrimaryKeySelective(TransportInfo transportInfo);

    /**
     * 根据主键查询对象
     */
    TransportInfo selectByPrimaryKey(Long id);

    /**
     * 根据uuid查询对象
     */
    TransportInfo selectByUuid(String uuid);
