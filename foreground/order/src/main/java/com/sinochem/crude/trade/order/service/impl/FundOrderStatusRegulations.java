 ...
 */
@Component
public class FundOrderStatusRegulations  implements OrderStatusRegulations {
...
//	@Override
	...
	public void after(OrderStatus orderStatus) {
		//Contract.orderStatus = 'XX${orderStatus.value}X'
		...
		contractOrderStatus = contractOrderStatus.substring(0,2) + orderStatus.getValue()
				+ contractOrderStatus.substring(3);
