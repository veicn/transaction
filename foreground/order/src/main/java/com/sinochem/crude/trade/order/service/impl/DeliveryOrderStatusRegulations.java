 ...
 */
@Component
public class DeliveryOrderStatusRegulations  implements OrderStatusRegulations {
...
//	@Override
	...
	public void after(OrderStatus orderStatus) {
		//Contract.orderStatus = 'X${orderStatus.value}XX'
		...
		contractOrderStatus = contractOrderStatus.substring(0,1) + orderStatus.getValue()
				+ contractOrderStatus.substring(2);
