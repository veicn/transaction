...
-- Records of accounts
-- ----------------------------
INSERT INTO `accounts` VALUES ('10001', '999999', '999999', '1', null, '0', '10002,10001', '2017-11-08 10:48:55', '10001', '2017-11-08 10:49:04', '10001');
...
-- ----------------------------
INSERT INTO `accounts_roles` VALUES ('10001', '1');
...
CREATE TABLE `members` (
  ...
  `update_user` bigint(12) NOT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1000000 DEFAULT CHARSET=utf8 COMMENT='会员';
...
INSERT INTO `members` VALUES ('999999', '系统管理员', '4028b8815f7a96af015f7a97dd1d9999', 'admin@sinochem.com', '0', '999999', '999999', null, null, null, '0', '0', null, null, null, '0', '0', '2017-11-10 09:41:03', '999999', '2017-11-10 09:40:59', '999999');
...
-- ----------------------------
INSERT INTO `role_permission` VALUES ('1', '1', '0', '2017-11-11 17:20:56', '1', '2017-11-11 17:21:04', '1');
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES ('1', '1', '1', 'super_admin', '0', '2017-11-09 17:35:20', '100001', '2017-11-09 17:35:29', '100001');
...
CREATE TABLE `sys_sms_code` (
  `sms_code_id` varchar(32) NOT NULL COMMENT '主键编号',
  `mobile` varchar(20) NOT NULL COMMENT '手机号码',
  `sms_code` varchar(20) NOT NULL COMMENT '短信验证码',
  `valid_type` varchar(50) DEFAULT NULL COMMENT '验证码类型',
  `sms_content` varchar(500) DEFAULT NULL COMMENT '短信内容',
  `active_time` int(11) DEFAULT NULL COMMENT '有效时间（秒）',
  `status` char(1) DEFAULT NULL COMMENT '状态',
  `send_time` datetime NOT NULL COMMENT '发送时间',
  `del_flg` char(1) NOT NULL DEFAULT '0' COMMENT '删除标志',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`sms_code_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='短信验证码记录表';
