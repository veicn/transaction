 ...
 * 购买商
 */
public class DemandRelevanterBuyerVO implements Serializable {
	...
	public DemandRelevanterBuyerVO() {
	}
	 ...
	 *            需求的领域模型
	 */
	public DemandRelevanterBuyerVO(DemandRelevanter demandRelevanter) {
	 ...
	 * @return
	 */
	public static DemandRelevanter convertVoToDomain(DemandRelevanterBuyerVO vo) {
	 ...
	 * @return
	 */
	public static DemandRelevanterBuyerVO convertDomainToVo(DemandRelevanter domain) {
		DemandRelevanterBuyerVO vo = new DemandRelevanterBuyerVO();
