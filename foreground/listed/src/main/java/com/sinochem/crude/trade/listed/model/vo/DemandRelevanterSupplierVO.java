 ...
 * 供应商
 */
public class DemandRelevanterSupplierVO implements Serializable {
	...
	public DemandRelevanterSupplierVO() {
	}
	 ...
	 *            需求的领域模型
	 */
	public DemandRelevanterSupplierVO(DemandRelevanter demandRelevanter) {
	 ...
	 * @return
	 */
	public static DemandRelevanter convertVoToDomain(
			DemandRelevanterSupplierVO vo) {
	 ...
	 * @return
	 */
	public static DemandRelevanterSupplierVO convertDomainToVo(DemandRelevanter domain) {
		DemandRelevanterSupplierVO vo = new DemandRelevanterSupplierVO();
