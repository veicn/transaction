...
public class PricingFormulaInfoForm {
	...
	/*********** 点价的特殊字段 start **********/
	private Date deadline;//点价截止时间
	private Integer monthOuterationTime;//可转月次数
	private Integer minOperAbleNum;//最小操作数量
	/*********** 点价的特殊字段 end **********/
	...
	public Integer getMonthOuterationTime() {
		return monthOuterationTime;
	}

	public void setMonthOuterationTime(Integer monthOuterationTime) {
		this.monthOuterationTime = monthOuterationTime;
	}

	public Integer getMinOperAbleNum() {
		return minOperAbleNum;
	}

	public void setMinOperAbleNum(Integer minOperAbleNum) {
		this.minOperAbleNum = minOperAbleNum;
	}
