			  ...
			  var curIndex = layer.open({
					...
					yes: function(index, layero){
						...
						if (checkOilId) {
							...
							layer.alert("Please choose grade!", {title:"Notice", btn: "OK"});
							return false;
						}
...
//			   	$(".layui-layer-title").css("background-color","#317ee7");
    ...
    function getContent(dataList,queryNm){
		...
		content = content + 			'<input type="text" id="queryCrudeNm" placeholder="Enter grade" value="' + queryNm + '" class="layui-input" style="width:250px;display:inline;"/>';
