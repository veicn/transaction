...
public class productOilController {
   ...
   // private URLBroker listedServer;
    ...
    @Value("${make.an.prodOrderManage}")
    private String prodOrderManage;*/
    @Value("${make.an.buyersOrder}")
    private String buyersOrder;
    @Value("${make.an.purchasingInfor}")
    private String purchasingInfor;
    ...
    @RequestMapping("om/ifroms/prodOrderManage.htm")
    public void findprodOrderManage(ModelMap modelMap){

        modelMap.put("prodOrderManage",prodOrderManage);
    }
