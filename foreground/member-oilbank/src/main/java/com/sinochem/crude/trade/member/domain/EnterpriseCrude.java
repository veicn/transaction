...
public class EnterpriseCrude {
    ...
    // 壹化网注册授权委托书
    private String yihuaRegisterFile;
    ...
    public String getYihuaRegisterFile() {
        return yihuaRegisterFile;
    }

    public void setYihuaRegisterFile(String yihuaRegisterFile) {
        this.yihuaRegisterFile = yihuaRegisterFile;
    }
