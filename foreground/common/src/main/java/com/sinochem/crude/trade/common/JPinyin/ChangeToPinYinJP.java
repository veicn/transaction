package com.sinochem.crude.trade.common.JPinyin;
...
public class ChangeToPinYinJP {
    ...
    public static String changeToGetShortPinYin(String pinYinStr) {
        ...
        try {
            tempStr = PinyinHelper.getShortPinyin(pinYinStr).toUpperCase();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return tempStr;
  ...
  public static void main(String[] args) {
      ...
      System.out.println(ChangeToPinYinJP.changeToGetShortPinYin("a李贝").toUpperCase());
