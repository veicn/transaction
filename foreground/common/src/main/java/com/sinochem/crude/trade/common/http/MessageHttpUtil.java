package com.sinochem.crude.trade.common.http;
...
public class MessageHttpUtil {
    public static final String MAIL_URL = "/mail/sendMail.json";
    ...
    public static String upload(HttpClient httpClient, String url, File file) throws BizException {
        try {
            ...
            builder.addPart("type", new StringBody("0", ContentType.TEXT_PLAIN));
            builder.addPart("docType", new StringBody("YYZZ", ContentType.TEXT_PLAIN));
            builder.addPart("objectId", new StringBody(CommonUtils.PLANTFORM_MEMBER_ID + "", ContentType.TEXT_PLAIN));
            ...
            if (httpResponse.getStatusLine().getStatusCode() == 200) {//如果状态码为200,就是正常返回
                ...
                throw new BizException("http请求异常:" + httpResponse.getStatusLine().getStatusCode());
            }
     ...
     * @return
     */
    public static List<NameValuePair> generateMailParams(Long memberId, String receiver, String content, String subject) {
        ...
        Object[] params = new Object[]{memberId, receiver, content, subject};
     ...
     * @return
     */
    public static List<NameValuePair> generateNomalPushParams(String title, String content, Integer level, Long memberId, Long receiver) {
        List<NameValuePair> param = new ArrayList<NameValuePair>();
        param.add(new BasicNameValuePair("fromId", memberId + ""));
        param.add(new BasicNameValuePair("createUser", memberId + ""));
        param.add(new BasicNameValuePair("level", level + ""));
        param.add(new BasicNameValuePair("title", title));
        param.add(new BasicNameValuePair("content", content));
        param.add(new BasicNameValuePair("toId", receiver + ""));
        Object[] params = new Object[]{receiver, content, title, memberId, level, memberId};
        String sign = Digest.digestWithMD5(params, MESSAGE_SALT);
        param.add(new BasicNameValuePair("sign", sign));
        return param;
    }
     ...
     * @return
     */
    public static List<NameValuePair> generateNomalSmsParams(String mobileNo, String content, Long memberId) {
        List<NameValuePair> param = new ArrayList<NameValuePair>();
        param.add(new BasicNameValuePair("memberId", memberId + ""));
        param.add(new BasicNameValuePair("strMobileNo", mobileNo));
        param.add(new BasicNameValuePair("strContent", content));
        Object[] params = new Object[]{content, mobileNo, memberId};
        String sign = Digest.digestWithMD5(params, MESSAGE_SALT);
        param.add(new BasicNameValuePair("sign", sign));
        return param;
    }
