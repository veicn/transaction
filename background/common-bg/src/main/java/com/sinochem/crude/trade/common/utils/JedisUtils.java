...
public class JedisUtils {
	...
	public static String KEY_PREFIX = "infobg";
	
	public static void init(JedisPool jedisPool, RedissonClient redissonClient) {
		if (JedisUtils.jedisPool == null) {
			JedisUtils.jedisPool = jedisPool;
		}


        JedisUtils.redissonClient = redissonClient;
		logger.info("load jedisPool implement: " + jedisPool.getClass().getName());
	}
