...
import com.sinochem.crude.trade.common.aliyun.oss.impl.OssFileManager;
...
public class OssConfig {
    ...
    @Bean
    public FileManager fileManager(OSSClient ossClient) {
        return new OssFileManager(ossClient, accessKeyId, showHost);
    }
}
