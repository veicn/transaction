...
public class ChannelM implements Serializable {
	...
	map.put("channelMCode",this.channelMCode);
	map.put("channelMName",this.channelMName);
	map.put("channelMDesc",this.channelMDesc);
	map.put("channelMOrder",this.channelMOrder);
