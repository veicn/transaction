...
public class BrowsingRecord implements Serializable {
	...
	/**浏览人ID*/
	private String browsingUserId;  
	
	/**平台  苹果交易版:app_ios_trade 安卓交易版:app_android_trade 苹果商机版:app_ios_oppor 

安卓商机版:app_android_oppor PC版:web h5版:h5app*/
	...
	/**浏览人ID*/
	public void setBrowsingUserId(String browsingUserId){
		this.browsingUserId=browsingUserId;
	}
	/**浏览人ID*/
	public String getBrowsingUserId(){
...
安卓商机版:app_android_oppor PC版:web h5版:h5app*/
	...
	map.put("browsingUserId",this.browsingUserId);
