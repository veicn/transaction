...
public interface InfoMapper {
	...
	public Info selectInfoById(Long objId);

	public Map<String, Object> getInfoByUuid(String infoUuid);

	public List<Map<String, Object>> hotInfoList();

	public Integer updateInfo(Map<String, Object> beanToMap);
	
	public List<Map<String, Object>> findByBizId(Info info);

	public Page<Map<String, Object>> queryInfoListByBizId(Map<String, Object> beanToMap);
