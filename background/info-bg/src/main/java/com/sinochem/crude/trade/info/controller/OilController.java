...
/**
 * @ClassName: OilNavigationController
 * @Description: 石油导航
 * @author xuebw
 * @date 2017年12月6日 下午16:33:58
 * 
 */
@Controller
public class OilController {
	...
	Log log = LogFactory.getLog(OilController.class);
	/**
	 * 列表查询(待审核)
	 * 
	 * @param user
	...
	@RequestMapping(value = "/om/oil/oil.htm")
	public void audit(/* CurrentUser user, */ModelMap modelMap,
		...
		mapn.put("channelMDesc", Constants.channel_m_desc_enum.channel_m_desc_SSBK.getChannel_m_desc_key());
	...
	@RightAccess(1061)
	@RolesAccess({"admin","info_oper"})
	@RequestMapping(value = "/om/oil/oilPublish.htm")
