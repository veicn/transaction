...
public interface BasePriceInterfaceService {
	
	public abstract BasePriceInterfaceMapper getMapper(); 
	
	/**
	 * 新增
	 */
	int insertRecord(BasePriceInterface basePriceInterface);
	 ...
	 * 根据主键-修改对象
	 */
	int updateRecordById(BasePriceInterface basePriceInterface) throws BizException;
	 ...
	 * 根据条件-批量修改数据(危险慎用)
	 */
	int updateRecords(BasePriceInterface basePriceInterface);
	
	
	/**
	 * 根据主键-查询对象
	 */
	BasePriceInterface findByPrimaryKey(Long id);

	/**
	 * 根据uuid查询对象
	 */
	BasePriceInterface findByUuid(String uuid);
 
	
	/**
	 * 根据对象-查询对象列表
	 */
	List<BasePriceInterface> queryByEntitys(BasePriceInterface basePriceInterface);
