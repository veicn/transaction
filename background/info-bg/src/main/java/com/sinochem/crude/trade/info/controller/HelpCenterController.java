...
public class HelpCenterController {
	...
	Log log = LogFactory.getLog(HelpCenterController.class);
	...
	@RequestMapping(value = "/om/help/HelpCenterAudit.htm")
	public void audit(/* CurrentUser user, */ModelMap modelMap,
		...
		mapn.put("channelMDesc", Constants.channel_m_desc_enum.channel_m_desc_HELP.getChannel_m_desc_key());
	...
	@RightAccess(1117)
	@RolesAccess({"admin","info_oper"})
	@RequestMapping(value = "/om/help/HelpCenterPublish.htm")
