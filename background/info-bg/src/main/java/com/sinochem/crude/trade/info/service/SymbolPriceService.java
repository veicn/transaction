...
public interface SymbolPriceService {
	...
	public abstract void saveSymbolPrice(Map<String, Object> map, String symbolCode, String symbolName, String string) throws Exception;

	public abstract void saveCrudeBasePrices(Integer days);

	public abstract void saveFutures(Integer days);

	public abstract void symbolPriceHandler(String ticksUrl, String scUrl); 
}
