...
public interface CrudeBasePriceService {
	
	public abstract CrudeBasePriceMapper getMapper(); 
	
	/**
	 * 新增
	 */
	int insertRecord(CrudeBasePrice basePrice);
	 ...
	 * 根据主键-修改对象
	 */
	int updateRecordById(CrudeBasePrice basePrice) throws BizException;
	 ...
	 * 根据条件-批量修改数据(危险慎用)
	 */
	int updateRecords(CrudeBasePrice basePrice);
	
	
	/**
	 * 根据主键-查询对象
	 */
	CrudeBasePrice findByPrimaryKey(Long id);

	/**
	 * 根据uuid查询对象
	 */
	CrudeBasePrice findByUuid(String uuid);
 
	
	/**
	 * 根据对象-查询对象列表
	 */
	List<CrudeBasePrice> queryByEntitys(CrudeBasePrice basePrice);
	...
	public abstract List<String> getDateList(String startDate);
