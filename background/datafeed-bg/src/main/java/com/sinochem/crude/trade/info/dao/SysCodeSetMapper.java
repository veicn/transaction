...
import com.sinochem.crude.trade.info.domain.SysCodeSet;
import com.sinochem.crude.trade.info.domain.SysCodeSetForUpdate;
import com.sinochem.crude.trade.info.domain.SysCodeSetOnlyGroup;
...
public interface SysCodeSetMapper {
	...
	//根据产品名称查询code
	public String queryCodeByProductName(String productName);
}
