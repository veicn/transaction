...
安卓商机版:app_android_oppor PC版:web*/
	...
	/**分享用户Id*/
	public void setSharUserId(String sharUserId){
		this.sharUserId=sharUserId;
	}
	/**分享用户Id*/
	public String getSharUserId(){
		return this.sharUserId;
	}
...
安卓商机版:app_android_oppor PC版:web*/
	...
	map.put("sharUserId",this.sharUserId);
	map.put("status",this.status);
	map.put("sharePlatform",this.sharePlatform);
