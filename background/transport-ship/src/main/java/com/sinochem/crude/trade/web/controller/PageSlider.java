...
public class PageSlider {
	...
	private String defaultFormSlider = "/contain/tablePageSlider";
	
	private String defaultFormSlider2 = "/contain/formPageSlider";

	private String defaultSlider = "/contain/pageSlider";

	private String defaultPageParameterName = "currentPage";
	
	private String defaultPageParameterName2 = "page";
	 ...
	 */
	@RequestMapping("/contain/tablePageSlider.htm")
	...
	public ModelAndView formPages(HttpServletRequest request) throws Exception {
		int totalPage = 0;
		int currentPage = 0;
		QueryBase query = (QueryBase) request.getAttribute("slider_query");
		if (query == null) {
		...
		List<Integer> grids = getGrids(totalPage, currentPage, width);
		String currentSlider = this.defaultFormSlider2;
		if ((temp = request.getAttribute("slider_path")) != null) {
			currentSlider = temp.toString();
		}

		String sliderPage = this.defaultPageParameterName2;
		if ((temp = request.getAttribute("slider_page")) != null) {
			sliderPage = temp.toString();
		}
