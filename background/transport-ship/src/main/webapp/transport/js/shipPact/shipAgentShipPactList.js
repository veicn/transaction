layui.use(['layer', 'form', 'laypage', 'table', 'laydate'], function(){
	...
	$('.queryBtn').on('click',function(){
		...
		window.location.href=shipServer+"/shipPact/shipAgentShipPactDetailQuery.htm?uuid="+uuid;
	});
	...
	$('.editBtn').on('click',function(){
		...
		window.location.href=shipServer+"/shipPact/shipAgentShipPactDetail.htm?uuid="+uuid+"&shipPlateUuid="+shipPlateUuid;
	});
