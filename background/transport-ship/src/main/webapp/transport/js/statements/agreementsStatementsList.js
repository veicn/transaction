layui.use(['layer', 'form', 'jquery','laypage', 'table', 'laydate'], function(){
	...
	$('.edit').on('click',function(){
		...
		window.location.href=shipServer+"/statements/statementsEdit.htm?uuid="+uuid;
	}); 
	function search(){
		var receiptCode = $('#receiptCode').val();
		var agreementCode = $('#agreementCode').val();
		window.location.href=shipServer+"/statements/agreementsStatementsList.htm?receiptCode="+ receiptCode+'&'+"agreementCode="+agreementCode;
	}
