...
// 删除cookie
    ...
    $.vs = function () {
        ...
        if (compareGoodsCookie != null) {
            ...
            window.compare && window.compare(idArr);
        }
    };
    $.delVSAll = function () {
        ...
        if (compareGoodsCookie != null) {
            for (var i = 0; i < compareGoodsCookie.length; i++) {
                ...
                if (compare != null && compare.id && compare.sn) {
                    ...
                    var h = "<li class=\"vs-item\"><img src=\"" + compare.imgPath + "\" alt=\"" + compare.name + "\" title=\"" + compare.name + "\" /><span title=\"" + compare.name + "\">" + shortname + "</span><a class=\"icon ico-delete\" href=\"javascript:;\" onclick=\"vs.delCom('" + idsn + "')\"></a></li>";
                    box.append(h);
                }
            }
        }
