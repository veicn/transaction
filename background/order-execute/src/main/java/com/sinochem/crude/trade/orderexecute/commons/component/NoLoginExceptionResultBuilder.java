...
import com.sinochem.it.b2b.member.access.NoLoginResultBuilder;
 ...
 * @Version : 1.0.0
 */
@BeanOverride(override = NoLoginResultBuilder.class)
@Component("nooLoginResultBuilder")
public class NoLoginExceptionResultBuilder extends
		NoLoginResultBuilder{
