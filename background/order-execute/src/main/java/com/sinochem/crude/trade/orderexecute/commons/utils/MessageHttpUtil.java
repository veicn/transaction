...
import com.sinochem.it.b2b.common.security.Digest;
...
public class MessageHttpUtil {
    ...
    public static List<NameValuePair> generateTplMailParams(String tplName, String subject, String receiver, Map<String, Object> model) {
        ...
        String sign = DigestUtil.digestWithMD5(params, MESSAGE_SALT);
    ...
    public static List<NameValuePair> generateMessageParams( String tplName, String toId, String level,String title,Map<String, Object> model){
    	String modelJsonStr = JSONObject.toJSONString(model);
    	return generateMessageParams(tplName, toId, level, title, modelJsonStr);
    }
    public static List<NameValuePair> generateMessageParams( String tplName, String toId, String level,String title,String modelJsonStr) {
        ...
        param.add(new BasicNameValuePair("model", modelJsonStr));
        ...
        Object[] params = new Object[]{tplName,modelJsonStr, toId, title,CommonUtils.PLANTFORM_MEMBER_ID + "",level, CommonUtils.PLANTFORM_MEMBER_ID + ""};
        String sign = DigestUtil.digestWithMD5(params, MESSAGE_SALT);
        param.add(new BasicNameValuePair("sign", sign));
        return param;
    }
    ...
    public static List<NameValuePair> generateAPPParams(String tplName, String toId,Map<String, Object> model){
    	String modelJsonStr = JSONObject.toJSONString(model);
    	return generateAPPParams(tplName, toId, modelJsonStr);
    }
    public static List<NameValuePair> generateAPPParams(String tplName, String toId,String modelJsonStr) {
        ...
        Object[] params = new Object[]{modelJsonStr,tplName,0L,"2","text","1",new String[]{toId},new Integer[]{0}};
